    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/antifraud/transaction/**").hasRole(String.valueOf(Role.MERCHANT))
                        .requestMatchers(HttpMethod.PUT, "/api/antifraud/transaction/**").hasRole(String.valueOf(Role.SUPPORT))
                        ...
                        .requestMatchers("/api/antifraud/history/**").hasRole(String.valueOf(Role.SUPPORT))
